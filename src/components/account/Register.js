...
const Register = ({start, setDidLogin}) => {
  ...
  return (
    <div>
      <button className="registerButton profileButton" onClick={handleOpen}>Register</button>
            ...
            <motion.div className="reg" initial={false} animate={open ? "open" : "closed"} variants={variants}>
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                <div className="formContainer">
                  ...
                  <span className="logRegError">{errors.email && errors.email.message}</span>
                  <input
                    name="email"
                    placeholder="email"
                    className="logRegInput"
                  ...
                  <span className="logRegError">{errors.school && errors.school.message}</span>
                  <input
                    name="school"
                    placeholder="school"
                    className="logRegInput"
                    ...
                    ref={register({
                      ...
                      maxLength : {
                        value: 15,
                        message: 'Too long, please use a shorter version'
                      }
                    })}
                  />

                  <span className="logRegError">{errors.country && errors.country.message}</span>
              ...
              <span>Tip: If your name contains non-ascii characters please consider using the email for loging in.</span>
            </motion.div>
        </motion.div>
    </div>
  );
